...
nightmare
    ...
    .type('input[name="reg_email__"]', 'mobile')
    .select('#sex', '1')
    .type('#birthday_day', '01')
    .type('#birthday_month', '01')
    .type('#birthday_year', '1999')
    .type('input[name="reg_passwd__"]', 'pass!@#word123')
    .click('#signup_button')
    .wait(40000)
    .evaluate(function() {
    ...
    .then(function(body) {
        if(body.indexOf('Security check' !== -1)) {
            return nightmare
                   .type('input[name="contact_point"]', 'mobile')
