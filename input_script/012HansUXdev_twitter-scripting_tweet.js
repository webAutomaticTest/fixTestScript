...
function Tweet(TW_USER,TW_PASS,message){
  ...
  .goto('https://twitter.com/login/')
    .insert('.js-username-field.email-input.js-initial-focus[name="session[username_or_email]"]', '888ch666@163.com')
    .insert(".js-password-field[name='session[password]']", 'ZXCVBNM<>?')
  ...
  // open the tweet panel
    ...
    .type('#tweet-box-global', "test!! are you showing off #nightmareJS in class?")
    // click to send
